...
export function RevenueChart() {
  ...
  return (
    <Card className="col-span-2 border-0 bg-card shadow-sm dark:shadow-none dark:border dark:border-border/50 animate-fade-up animation-delay-300">
      ...
      <CardContent>
        <div className="mb-6 flex items-baseline gap-3">
          ...
          <span className="flex items-center gap-1.5 rounded-full bg-emerald-50 dark:bg-emerald-950 px-2.5 py-1 text-xs font-semibold text-emerald-600 dark:text-emerald-400">
